...
- Keep the Showreel unchanged and place the new About section immediately below it.
- Replace the About, Services, Projects, and Contact page copy with the supplied content while retaining current project images, post gallery, and videos.
- Build the contact form as a WhatsApp enquiry form, so submitting it opens a pre-filled message without requiring data storage.
- Add a Karachi map embed to Contact using a standard Google Maps embed URL that does not require a new connection.
- Replace the shared footer copy, links, service list, contact details, Facebook link, SEO paragraph, and copyright.
...
- Verify navigation, contact submission, mobile layout, and the final preview after the content replacement.
