    ...
    <footer className="border-t border-border bg-card/40">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div className="md:col-span-2">
          ...
          <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground">
            ...
            solution for renovation, interior and construction in Karachi.
          </p>
          <a
            href={site.facebook}
            target="_blank"
        ...
        <div>
          ...
          <h3 className="mt-8 text-xs font-bold uppercase tracking-[0.28em] text-primary">
            Services
          </h3>
        ...
        <div>
          ...
          <ul className="mt-5 space-y-4 text-sm text-muted-foreground">
            <li>
              <a href={`tel:${site.phoneTel}`} className="flex gap-3 hover:text-primary">
      ...
      <div className="border-t border-border px-5 py-7 text-center text-xs leading-relaxed text-muted-foreground">
        <p className="mx-auto max-w-5xl">
          Tameer Construction is a construction company in Karachi, Pakistan, offering house
          construction, home renovation, interior design, grey structure, turnkey construction and
          building material supply across Karachi.
        </p>
        <p className="mt-4">
          © 2026 Tameer Construction & Interior. All Rights Reserved. | Designed with trust in
          Karachi.
        </p>
      </div>
    </footer>
